          ...
          <div class="col-lg-6">
            ...
            <div class="block">
              <div class="block-body">
                <form class="form" method="POST" action="/admin/update_product/{{$product->id}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" placeholder="price" class="form-control" name="price" value="{{$product->price}}">
                  </div>
                  <div class="form-group">
                    <label class="form-control-label">quantity</label>
                    <input type="text" placeholder="quantity" class="form-control" name="quantity" value="{{$product->quantity}}">
                  </div>
                  <div class="form-group">
